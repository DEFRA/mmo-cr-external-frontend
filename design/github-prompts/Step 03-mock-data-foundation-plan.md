...
- **Assumption:** record **status→destination routing stays in the controller/journey helper**, not in data (per prompt §8 "do not put route destinations into source data"); only the record _content_ moves to the data layer.
